...
ActiveRecord::Schema.define(version: 20_180_901_142_832) do
  ...
  create_table 'cohort_students', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[student_id cohort_id], name: 'index_cohort_students_on_student_id_and_cohort_id'
  end
  ...
  create_table 'users', force: :cascade do |t|
    ...
    t.index %w[userable_type userable_id], name: 'index_users_on_userable_type_and_userable_id'
  end
